...
bar.show = function ()
  ...
  print(string.format("%s%s%s%s%s%s%s%s", fl, bar.date.show(), bar.weather.show(), bar.tmp.show(), bar.fan.show(), bar.load.show(), bar.net.show(), bar.colors.bgstop))
...
mybar.colors.bgc1 = "%{B#1a1b26}"
mybar.colors.sbg1 = "%{B#1a1b26}"
...
mybar.weather.sbg = mybar.colors.sbg5
...
mybar.net.sbg     = mybar.colors.bgc1
